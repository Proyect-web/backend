...
export interface ApiPaginaDeInicioPaginaDeInicio
  ...
  info: {
    ...
    pluralName: 'pagina-de-inicios';
    singularName: 'pagina-de-inicio';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    >;
    hero_subtitulo: Schema.Attribute.Text & Schema.Attribute.Required;
    hero_titulo: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-de-inicio.pagina-de-inicio'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variants: Schema.Attribute.Component<'elements.color-variante', true>;
  };
}
